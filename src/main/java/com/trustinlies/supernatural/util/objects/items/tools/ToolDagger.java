...
public class ToolDagger extends ItemSword implements IHasModel {
    ...
    public ToolDagger(String name, ToolMaterial material, String keyword){
        super(material);
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slotIn, ItemStack stack)
    {
        ...
        {
            replaceModifier(modifiers, SharedMonsterAttributes.ATTACK_SPEED /* or whatever attribute you want to modify */, ATTACK_SPEED_MODIFIER /* ... */,  3);
